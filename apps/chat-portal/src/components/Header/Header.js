...
export default function Header({ activeConv, activeTab, setActiveTab, profile, ...props }) {
  ...
  return (
    <div className={styles.headerContainer}>
      {activeConv ? (
        ...
        <ChatHeader 
          chatSearchText={props.chatSearchText} 
          setChatSearchText={props.setChatSearchText} 
          profile={profile}
